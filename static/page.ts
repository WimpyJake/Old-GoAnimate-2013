	...
	switch (url.pathname) {
			...
			params = {
				flashvars: {
					...
					bgload: "https://josephcrosmanplays532.github.io/animation/808/go_full.swf",
					lid: "13",
					ctc: "go",
					themeColor: "silver",
					tlang: "en_US",
...
<div style="display:none">
    ...
    <script>
        ...
        var studio_data = {
            id: "Studio",
            swf: "https://josephcrosmanplays532.github.io/animation/808/go_full.swf",
            width: "100%",
            height: "100%",
            align: "middle",
            allowScriptAccess: "always",
